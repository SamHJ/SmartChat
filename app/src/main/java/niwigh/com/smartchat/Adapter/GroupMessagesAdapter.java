...
public class GroupMessagesAdapter  extends RecyclerView.Adapter<GroupMessagesAdapter.MessageViewHolder> {
    ...
    public GroupMessagesAdapter (List<MessagesModel> userMessagesList,String group_category,
                                 String group_key,OnItemClickListener listener){
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView receiver_counter_timer,receiver_duration_timer,receiver_message_audio_time,sender_audio_title,
                sender_counter_timer, sender_duration_timer, sender_message_audio_time,sender_text_message_name,
                sender_image_message_name,sender_video_message_name,sender_file_message_name,
                sender_audio_message_name;

        LinearLayout chatter_date_layout;
        TextView chatter_date_text;

        LinearLayout reply_sender_message_layout;
        TextView chatter_user_name_text,chatter_text_text,new_sender_message_text,
                new_sender_message_time,reply_sender_text_message_name;
        ...
        private MessageViewHolder(@NonNull View itemView) {
            ...
            reply_sender_text_message_name = itemView.findViewById(R.id.reply_sender_text_message_name);
            ...
            //sender names
            sender_text_message_name = itemView.findViewById(R.id.sender_text_message_name);
            sender_image_message_name = itemView.findViewById(R.id.sender_image_message_name);
            sender_video_message_name = itemView.findViewById(R.id.sender_video_message_name);
            sender_file_message_name = itemView.findViewById(R.id.sender_file_message_name);
            sender_audio_message_name = itemView.findViewById(R.id.sender_audio_message_name);
        ...
        public void bind(final MessagesModel messagesModel,
                         final OnItemClickListener listener, View itemView,
                         final int position) {
    ...
    public MessageViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View V = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.group_chat_messages_layout, viewGroup, false);
        ...
        usersDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    try{
                        Picasso.with(messageViewHolder.receiverProfileImage.getContext()).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                        ...
                        Picasso.with(messageViewHolder.receiverImageProfileImage.getContext()).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                                ...
                                new Callback() {
                                    ...
                                    public void onError() {
                                        ...
                                        Picasso.with(messageViewHolder.receiverImageProfileImage.getContext()).load(image)
                                                .placeholder(R.drawable.easy_to_use).into(messageViewHolder.receiverImageProfileImage);
                                    }
                                });

                        Picasso.with(messageViewHolder.receiver_profile_file_for_image.getContext()).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                                ...
                                new Callback() {
                                    ...
                                    public void onError() {
                                        ...
                                        Picasso.with(messageViewHolder.receiver_profile_file_for_image.getContext()).load(image)
                                                .placeholder(R.drawable.easy_to_use).into(messageViewHolder.receiver_profile_file_for_image);
                                    }
                                });
                        ...
                        Picasso.with(messageViewHolder.receiver_profile_audio_for_image.getContext()).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                                ...
                                new Callback() {
                                    ...
                                    public void onError() {
                                        ...
                                        Picasso.with(messageViewHolder.receiver_profile_audio_for_image.getContext()).load(image)
                                                .placeholder(R.drawable.easy_to_use).into(messageViewHolder.receiver_profile_audio_for_image);
                                    }
                                });
...
//        ,
        ...
        if(fromMessageType.equals("text")){
            ...
            if(fromUserID.equals(messageSenderID)){
                ...
                usersRef.child(messagesModel.getFrom()).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            if(dataSnapshot.hasChildren()){
                                String sender_name = dataSnapshot.child("fullname").getValue().toString();
                                messageViewHolder.sender_text_message_name.setText(sender_name);
                            }
                        }
                    }
                ...
                usersRef.child(messagesModel.getFrom()).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            if(dataSnapshot.hasChildren()){
                                String sender_name = dataSnapshot.child("fullname").getValue().toString();
                                messageViewHolder.sender_image_message_name.setText(sender_name);
                            }
                        }
                    }
                ...
                usersRef.child(messagesModel.getFrom()).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            if(dataSnapshot.hasChildren()){
                                String sender_name = dataSnapshot.child("fullname").getValue().toString();
                                messageViewHolder.sender_file_message_name.setText(sender_name);
                            }
                        }
                    }
                ...
                usersRef.child(messagesModel.getFrom()).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            if(dataSnapshot.hasChildren()){
                                String sender_name = dataSnapshot.child("fullname").getValue().toString();
                                messageViewHolder.sender_video_message_name.setText(sender_name);
                            }
                        }
                    }
                ...
                usersRef.child(messagesModel.getFrom()).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            if(dataSnapshot.hasChildren()){
                                String sender_name = dataSnapshot.child("fullname").getValue().toString();
                                messageViewHolder.sender_audio_message_name.setText(sender_name);
                            }
                        }
                    }
                    ...
                    usersRef.child(messagesModel.getFrom()).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.exists()){
                                if(dataSnapshot.hasChildren()){
                                    String sender_name = dataSnapshot.child("fullname").getValue().toString();
                                    messageViewHolder.reply_sender_text_message_name.setText(sender_name);
                                }
                            }
                        }
            ...
            messageViewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    if(userMessagesList.get(position).getType().equals("document")){
                        ...
                        builderoptions_doc.setTitle("Message Options");
                        ...
                        builderoptions_image.setTitle("Message Options");
                        ...
                        builderoptions_text.setTitle("Message Options");
            ...
            messageViewHolder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    ...
                    if(userMessagesList.get(position).getType().equals("video")){
                        ...
                        builderoptions_r_image.setTitle("Message Options");
                        ...
                        builderoptions_r_text.setTitle("Message Options");
    ...
    private void DeleteSentMessages(final int position, final MessageViewHolder holder){
        ...
        groupsRef.child("Messages").child(userMessagesList.get(position).getMessageID())
    ...
    private void CopyToClipBoard(final int position, final MessageViewHolder holder){
        ...
        if(Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB){
            ...
            clipboardManager.setText(userMessagesList.get(position).getMessage());
        }
        else {
            ...
            android.content.ClipData clipData = android.content.ClipData.newPlainText("Text Copied", userMessagesList
